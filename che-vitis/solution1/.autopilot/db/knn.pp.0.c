...
# 122 "C:/Xilinx/Vitis_HLS/2020.2/tps/mingw/6.2.0/win64.o/nt\\x86_64-w64-mingw32\\include\\float.h" 3
...
#pragma pack(pop)
# 123 "C:/Xilinx/Vitis_HLS/2020.2/tps/mingw/6.2.0/win64.o/nt\\x86_64-w64-mingw32\\include\\float.h" 2 3
...
# 26 "C:/Xilinx/Vitis_HLS/2020.2/tps/mingw/6.2.0/win64.o/nt\\x86_64-w64-mingw32\\include\\assert.h" 3
...
# 40 "C:/Xilinx/Vitis_HLS/2020.2/tps/mingw/6.2.0/win64.o/nt\\x86_64-w64-mingw32\\include\\assert.h" 3
...
void initialize_best(BestPoint_SoA *best_points, int k, int num_features) {
    VITIS_LOOP_29_1: for (int i = 0; i < 20; i++) {

        best_points->distance[i] = 1.7976931348623157e+308;

        best_points->classification_id[i] = (char) -1;
    }
}
...
void update_best(double distance, char classID,
    ...
    VITIS_LOOP_48_1: for (int i = 0; i < 20; i++) {
